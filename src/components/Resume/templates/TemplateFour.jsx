    ...
    <div className="w-full mx-auto bg-white p-8 border border-gray-200 shadow-md">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-2 p-4">
          <h2 className="text-xl font-semibold mb-2 text-black">Profil</h2>
      ...
      <div className="grid grid-cols-3 gap-4 mt-6">
        <div className="col-span-3 bg-blue-100 p-4">
          <h2 className="text-xl font-semibold mb-2 text-black">Bildungsweg</h2>
      ...
      <div className="grid grid-cols-3 gap-4 mt-6">
        ...
        <div className="col-span-1 bg-blue-50 p-4">
          <h2 className="text-xl font-semibold mb-2 text-black">Sprachen</h2>
